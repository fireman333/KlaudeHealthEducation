...
summary: "NCCN 沒有強制肺腺癌一定要住院做檢查。實務上會建議住院，多半是為了一週內把 CT、PET、MRI、切片、基因檢測一次跑齊，跟「病情有沒有很差」是兩回事。"
description: "NCCN 沒有強制肺腺癌一定要住院做檢查。實務上會建議住院，多半是為了一週內把 CT、PET、MRI、切片、基因檢測一次跑齊，跟「病情有沒有很差」是兩回事。"
sources:
...
2. **完整的 workup** 包括胸腹 CT、PET-CT、腦部 MRI、切片、多基因檢測。任何一個略過都可能讓分期或治療策略走偏。
