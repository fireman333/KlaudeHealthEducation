...
sources:
  - title: "2023 ACC/AHA/ACCP/HRS Guideline for the Diagnosis and Management of Atrial Fibrillation (Joglar et al., JACC 2024)"
    url: "https://doi.org/10.1016/j.jacc.2023.08.017"
    note: "JACC 2024;83(1):109-279 — 「valvular / non-valvular」二分法建議淘汰；新定義 valvular AF 限縮為中度以上二尖瓣狹窄或機械瓣膜"
  - title: "INVICTUS — Rivaroxaban in Rheumatic Heart Disease-Associated Atrial Fibrillation (Connolly et al., NEJM 2022)"
    url: "https://pubmed.ncbi.nlm.nih.gov/36036525/"
    note: "n=4531 RCT — vitamin K antagonist 組限制平均存活時間 1675 天 vs rivaroxaban 1599 天，差 76 天（95% CI -121 至 -31, P<0.001）"
  - title: "When Direct Oral Anticoagulants Should Not Be Standard Treatment (Bejjani et al., JACC 2024)"
    url: "https://doi.org/10.1016/j.jacc.2023.10.038"
    note: "JACC 2024;83(3):444-465 — 綜合 RE-ALIGN（dabigatran 中止）、PROACT Xa（apixaban On-X 中止）對機械瓣膜不能用 DOAC 的證據"
  - title: "RIVER — Rivaroxaban in Patients with Atrial Fibrillation and a Bioprosthetic Mitral Valve (Guimarães et al., NEJM 2020)"
    url: "https://pubmed.ncbi.nlm.nih.gov/33196155/"
    note: "n=1005 RCT，巴西 — rivaroxaban 不劣於 warfarin（restricted mean survival 7.4 天 差距, P<0.001 noninferiority）；中風 0.6% vs 2.4%（HR 0.25, 95% CI 0.07-0.88）"
  - title: "ENVISAGE-TAVI AF — Edoxaban versus Vitamin K Antagonist for Atrial Fibrillation after TAVR (Van Mieghem et al., NEJM 2021)"
    url: "https://pubmed.ncbi.nlm.nih.gov/34449183/"
    note: "n=1426 RCT — efficacy noninferior (HR 1.05) 但 major bleeding noninferior 失敗（HR 1.40，主因腸胃道出血）"
  - title: "NOACs in Atrial Fibrillation and Valvular Heart Disease — pooled analysis of 4 pivotal trials (Renda et al., JACC 2017)"
    url: "https://doi.org/10.1016/j.jacc.2016.12.038"
    note: "ARISTOTLE / ROCKET-AF / ENGAGE-AF / RE-LY 共 71,683 受試者 pooled — VHD 亞群（除機械瓣膜 + 中度以上 MS） stroke/SE HR 0.70（95% CI 0.58-0.86）"
  - title: "心房顫動的心律不整藥物治療簡介 — 臺大醫院藥劑部蔡承洋藥師（2022/06）"
    url: "https://epaper.ntuh.gov.tw/health/202206/project_3.html"
    note: "NTUH 健康電子報 — AF 中風風險是一般人 3-5 倍；患者口服抗凝血劑治療概念、台灣 patient-facing 衛教"
  - title: "EAST-AFNET 4 — Early Rhythm-Control Therapy in Patients with Atrial Fibrillation (Kirchhof et al., NEJM 2020)"
    url: "https://pubmed.ncbi.nlm.nih.gov/32865375/"
    note: "n=2789 RCT，新診斷 AF（≤1 年）+ 共病 — 主要終點 HR 0.79（96% CI 0.66-0.94, P=0.005），試驗因 efficacy 提前停止"
  - title: "CABANA — Catheter Ablation versus Antiarrhythmic Drug Therapy (Packer et al., JAMA 2019)"
    url: "https://pubmed.ncbi.nlm.nih.gov/30874766/"
    note: "n=2204 RCT — primary HR 0.86（n.s.）；AF recurrence HR 0.52（P<0.001）；27.5% 藥物組 crossover 到電燒"
  - title: "CASTLE-AF — Catheter Ablation for Atrial Fibrillation with Heart Failure (Marrouche et al., NEJM 2018)"
    url: "https://pubmed.ncbi.nlm.nih.gov/29385358/"
    note: "n=363 RCT，LVEF≤35% — 主要終點 HR 0.62（28.5% vs 44.6%, P=0.007）；廠商 Biotronik 贊助、小樣本外推需保留"
  - title: "2020 ACC/AHA Guideline for the Management of Patients With Valvular Heart Disease (Otto et al., JACC 2021)"
    url: "https://doi.org/10.1016/j.jacc.2020.11.018"
    note: "JACC 2021;77(4):e25-e197 — 嚴重 atrial functional MR Class IIb 可考慮手術；MR 修補 vs 置換決策"
  - title: "抗凝血藥物簡介 — 臺大醫院藥劑部陳婕恩藥師（2023/06）"
    url: "https://epaper.ntuh.gov.tw/health/202306/project_3.html"
    note: "NTUH 健康電子報 — AF 中風風險、口服 / 注射型抗凝血劑分類、用藥安全衛教"
carousel:
  - src: "/img/posts/2026-05-12-af-valvular/01-hook.png"
    alt: "封面：心房顫動會把瓣膜弄壞嗎？valvular AF / non-valvular AF 與抗凝血劑選擇"
    caption: "Slide 1 — Hook"
    threads_text: "〈康勞德醫普〉「我媽 75 歲確診心房顫動，朋友說有比較新的藥不用驗血，可以改吃嗎？」\n\n答案是：要看她瓣膜的狀況。\n\n2023 年美國心臟學會（ACC/AHA）的心房顫動指引直接寫：「valvular AF」「non-valvular AF」這兩個老詞應該被淘汰。\n\n4 張圖帶你看完抗凝血劑怎麼選 👇\n\n#康勞德醫普 #心房顫動"
  - src: "/img/posts/2026-05-12-af-valvular/02-data.png"
    alt: "INVICTUS：風濕性二尖瓣狹窄 + AF 族群，warfarin 仍贏 rivaroxaban 76 天存活時間"
    caption: "Slide 2 — INVICTUS 翻轉了「新藥都比較好」的直覺"
    threads_text: "INVICTUS 試驗（New England Journal of Medicine, 2022, n=4,531 隨機分組）：\n\n風濕性二尖瓣狹窄 + 心房顫動的病人，吃 warfarin（傳統老藥）vs rivaroxaban（新型口服抗凝血劑，DOAC）\n\n結果 — 限制平均存活時間 warfarin 1675 天 vs rivaroxaban 1599 天，差 76 天（P<0.001）。\n\n「新藥輸了」。而且贏的是死亡（不是中風或大出血），機制至今未完全明。\n\n所以風心症 + 二尖瓣狹窄 + AF，warfarin 仍是標準。"
  - src: "/img/posts/2026-05-12-af-valvular/03-decision.png"
    alt: "AF + 瓣膜疾病的抗凝血劑選擇樹：5 個情境"
    caption: "Slide 3 — 5 個情境的抗凝血劑選擇樹"
    threads_text: "AF 加瓣膜疾病的抗凝血劑選擇，5 個情境：\n\n1. 中度以上二尖瓣狹窄（特別是風心症）→ warfarin（INVICTUS）\n2. 機械瓣膜（人工金屬瓣膜）→ warfarin（RE-ALIGN / PROACT Xa 都中止了）\n3. 生物瓣膜 → DOAC 可以（RIVER trial）\n4. 經導管主動脈瓣置換（TAVR）後 → DOAC 或 warfarin 都可以（ENVISAGE-TAVI）\n5. 二尖瓣逆流（沒狹窄）→ DOAC 可以\n\n「新 vs 舊」不是這個故事的主軸；「瓣膜本身在做什麼」才是。"
  - src: "/img/posts/2026-05-12-af-valvular/04-takeaway.png"
    alt: "Take-home：valvular AF 新定義只剩兩種；節律控制早期介入有好處；心衰 + AF 是電燒明確獲益族群"
    caption: "Slide 4 — Take-home + CTA"
    threads_text: "Take-home：\n\n1. 「valvular AF」新定義只剩 2 種：中度以上二尖瓣狹窄 + 機械瓣膜 — 這兩種必須用 warfarin；其餘 AF + 瓣膜疾病都可以用新型口服抗凝血劑（DOAC）。\n2. EAST-AFNET 4 試驗：新診斷 + 有共病的 AF 病人，早期介入節律控制（藥物 / 電燒）主要終點降 21%。CASTLE-AF 試驗：AF + 心衰 + LVEF≤35% 從電燒得到的好處最明確（死亡風險降 47%）。\n3. 抗凝血劑選擇是個別化決定：把瓣膜狀況、出血風險、用藥便利、健保給付、洗腎 / 肝功能一起考慮，跟心臟科醫師討論。\n\n完整衛教整理 → fireman333.github.io/KlaudeHealthEducation/posts/2026-05-12-atrial-fibrillation-valvular-disease-anticoagulation/\n\n⚠ 作者為醫學生（非主治醫師），衛教整理，不構成個別醫療建議。\n\n#康勞德醫普 #心房顫動 #瓣膜疾病 #抗凝血劑"
---
...
問題不在「心律亂」本身。問題在 — 心房不規律收縮的時候，血液會在心房裡（特別是一個叫**左心耳**的小袋子）滯留打轉、容易形成血栓。血栓掉出來、順著血流往上跑進大腦的血管，就是缺血性中風。
...
但 **EAST-AFNET 4 試驗**（Kirchhof 等, *New England Journal of Medicine* 2020，n=2,789 隨機分組）翻轉了這個共識[8]。受試者 — 確診 AF ≤1 年、CHA₂DS₂-VASc 平均 3.4。隨機分到 early rhythm control（早期介入節律控制）vs usual care。中位追蹤 5.1 年（試驗因 efficacy 提前停止）：
