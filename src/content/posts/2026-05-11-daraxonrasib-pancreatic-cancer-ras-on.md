...
sources:
  - title: "Wolpin BM, Park W, Garrido-Laguna I, et al. — Daraxonrasib in Previously Treated Advanced RAS-Mutated Pancreatic Cancer, N Engl J Med 2026"
    ...
    note: "RMC-6236-001 phase 1–2 trial（NCT05379985），N=168 RAS-mutated PDAC；G12 subgroup 第二線 300 mg：ORR 35%、mDOR 8.2 月、mPFS 8.5 月、mOS 13.1 月"
  - title: "NCCN Clinical Practice Guidelines in Oncology: Pancreatic Adenocarcinoma v1.2026"
    url: "https://www.nccn.org/professionals/physician_gls/pdf/pancreatic.pdf"
    note: "Subsequent therapy 章節（PANC-G p.60–62）：KRAS 標靶 useful in certain circumstances 僅列 sotorasib / adagrasib（限 G12C），daraxonrasib 尚未收錄"
  - title: "Daraxonrasib Yields Significant Survival Advantages vs Chemotherapy in Metastatic Pancreatic Cancer — OncLive 2026"
    url: "https://www.onclive.com/view/daraxonrasib-yields-significant-survival-advantages-vs-chemotherapy-in-metastatic-pancreatic-cancer"
    note: "RASolute 302 phase 3 topline：daraxonrasib mOS 13.2 vs chemo 6.7 月、HR 0.40、p<0.0001"
  - title: "ClinicalTrials.gov NCT06625320 — Phase 3 Study of Daraxonrasib (RMC-6236) in Previously Treated Metastatic PDAC (RASolute 302)"
    url: "https://clinicaltrials.gov/study/NCT06625320"
    note: "Global, randomized, open-label phase 3：daraxonrasib 對比 standard-of-care chemo，主要終點 PFS / OS"
  - title: "Jiang J, Maldonato BJ, Holderfield M, et al. — Translational and Therapeutic Evaluation of RAS-GTP Inhibition by RMC-6236 in RAS-Driven Cancers, Cancer Discov 2024"
    url: "https://pubmed.ncbi.nlm.nih.gov/38593348/"
    note: "Daraxonrasib 機制論文：RAS(ON) multi-selective non-covalent tri-complex inhibitor，與 cyclophilin A 形成複合物鎖住 active GTP-bound RAS（含 mutant 與 wild-type）"
  - title: "楊士弘醫師（臺大醫院腫瘤醫學部）— 淺談胰臟癌治療「積極面對」是唯一解方，臺大醫院健康電子報 2023/11"
    url: "https://epaper.ntuh.gov.tw/health/202311/project_2.html"
    note: "台灣醫學中心 patient-facing 衛教：胰臟癌「癌王」現況、發現多在中晚期、需多專科團隊治療"
  - title: "衛生福利部 — 全球第一個證實可延長轉移性胰腺癌患者整體存活期：台灣 SLOG 化療配方刊登 Lancet"
    url: "https://www.mohw.gov.tw/cp-2651-19785-1.html"
    note: "台灣自主研發 S-1 + leucovorin + oxaliplatin + gemcitabine（SLOG）一線方案，研究結果整體存活期 11.4 月"
...
把 RAS 想像成細胞裡的**油門**。它有兩個位置：踩下去（active，與 GTP 結合）會把訊號往下傳給細胞核，命令細胞分裂；放開（inactive，與 GDP 結合）就停下來。**正常細胞的 RAS 油門踩一下會自動回彈**；KRAS 突變的癌細胞，這個油門卡死在踩到底的位置，細胞拚命分裂[5]。
...
根據 NCCN Pancreatic Adenocarcinoma v1.2026 指引中「Subsequent Therapy」章節（PANC-G p.60–62）[2]，**體能狀態 ECOG 0–1 的轉移性胰臟癌**第二線：
...
對照 sotorasib 的時間軸：CodeBreaK 100 phase 2 結果 2021 年發表 → FDA 加速核准 → 2022 年進入 NCCN 胰臟癌指引「Useful in Certain Circumstances」。Daraxonrasib 若按類似節奏，**最快 2027–2028 年**進入 NCCN 並獲 FDA 核准。

## 對台灣病人的實務意義

要看這個藥對台灣病人**今天**意味著什麼，得拆三層：
...
寫到這裡覺得很興奮，但還是要踩一下煞車——有幾件事**這篇 NEJM 試驗還沒回答**：
